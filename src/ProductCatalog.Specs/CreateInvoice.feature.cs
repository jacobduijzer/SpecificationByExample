...
#line hidden
        ...
        public CreatingAnInvoiceFromAShoppingBasketFeature(CreatingAnInvoiceFromAShoppingBasketFeature.FixtureData fixtureData, ProductCatalog_Specs_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Ordering hardcover books should add shipping costs")]
        [Xunit.TraitAttribute("FeatureTitle", "Creating an invoice from a shopping basket")]
        [Xunit.TraitAttribute("Description", "Ordering hardcover books should add shipping costs")]
        public void OrderingHardcoverBooksShouldAddShippingCosts()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Ordering hardcover books should add shipping costs", "    Placing an order with physical items should add shipping costs to the invoice" +
...
#line hidden
#line 45
        testRunner.Given("Simone has a shopping cart with: \'Specification By Example\' with format \'Hardcove" +
...
#line hidden
                ...
                table4.AddRow(new string[] {
                            "Hardcover: Specification By Example by Gojko Adzic",
                            "1x",
                            "31.49",
                            "0",
                            "31.49"});
...
#line 59
        testRunner.Given("Simone has a shopping cart with 10 copies of \'Specification By Example\' with form" +
                        "at \'Hardcover\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 60
        testRunner.When("she is going to pay her order", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
